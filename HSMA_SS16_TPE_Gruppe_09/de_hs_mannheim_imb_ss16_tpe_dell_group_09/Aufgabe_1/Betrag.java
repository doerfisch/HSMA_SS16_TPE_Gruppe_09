package Aufgabe_1;
	...
	public class Betrag {
		...
		//Betrag bereits mal 100 genommen, wird benutzt wenn saldo "überschrieben" wird
		...
		public long getNachkomma(){
			double KommaZahl;
			if (this.betrag < 0){
			KommaZahl = (-1)*(double)this.betrag/100;
			}
			else {
		...
		// Der Wert wird als double ausgegeben. Division durch 100, da wir in double die Nachkommastellen nutzen k�nnen
