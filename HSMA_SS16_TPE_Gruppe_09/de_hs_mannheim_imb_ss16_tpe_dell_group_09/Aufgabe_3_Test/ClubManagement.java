...
public class ClubManagement {
	...
	public static void main(String[] args) {
		...
		// Die Vereinsliste wird in eine zweite Liste kopiert und diese ausgegeben
		...
		// Die zweite Liste wird ausgegeben, dann das Mitglied mit der ID 2 (welches nicht vorhanden ist), dann das Mitglied mit der ID 2 in der zweiten Liste
		System.out.println("Zweite Liste:\n" + vereinsListeZwei);
		...
		// Hier wird der Vorname des Mitglieds mit der ID 5 in der ersten Liste geändert und das Mitglied danach ausgegeben
		vereinsListe.get(5).setVorname("GÃ¼nter");
		System.out.println("Erste Liste - Mitglied mit Nummer 5: " + vereinsListe.get(5) + "\n");
		// Das Mitglied mit der ID 5 wird in der zweiten Liste gelöscht und danach werden beide Listen ausgegeben
		vereinsListeZwei.remove(5);
		System.out.println("Erste Liste:\n" + vereinsListe + "\nZweite Liste:\n" + vereinsListeZwei);
		// Beide Listen werden geleert und danach die Länge der Liste ausgegeben - Da die Listen leer sind wird 0 ausgegeben
		vereinsListe.clear();
